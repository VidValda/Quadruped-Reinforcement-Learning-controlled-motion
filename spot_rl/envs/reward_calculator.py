...
class SpotRewardCalculator:
    def __init__(
        ...
        action_rate_weight: float = 0.035,
        control_cost_weight: float = 0.005,
        joint_vel_penalty_weight: float = 0.005,
        nominal_pose_penalty_weight: float = 0.25,
        foot_clearance_weight: float = 0.005,
